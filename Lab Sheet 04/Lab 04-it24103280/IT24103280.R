setwd("C:\\Users\\IT24103280\\Downloads\\Lab 04-20250819")
...
# Interpretation example (to include in your Word doc):
# The boxplot shows the distribution of sales with a median around X,
# presence or absence of outliers, and skewness if the box or whiskers are asymmetric.
